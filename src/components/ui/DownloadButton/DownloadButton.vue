...
export default {
    ...
    methods: {
        setInitialAnimation() {
            ...
            function animateButton(customDuration) {
                if (!button.classList.contains('loading')) {
                    if (customDuration) {
                        duration = customDuration
                        button.style.setProperty('--duration', customDuration);
                    }
    ...
    computed: {
        ...
        globalNavMenu() {
            return this.$store.getters.getlanguageObject.downloadMenu;
        },
    },
}
</script>
