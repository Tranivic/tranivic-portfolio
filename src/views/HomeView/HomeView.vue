<template>
    <section class="home-page">
        ...
        <div class="my-expertise container">
            <div class="row">
                <div class="card big">
                    ...
                    <div class="card-info">
                        ...
                        <h1>My Knowlege Grid</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, iure!</p>
                    </div>
